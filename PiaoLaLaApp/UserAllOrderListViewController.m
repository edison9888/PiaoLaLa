//
//  UserAllOrderListViewController.m
//  piaoLaLa
//
...
#import "UserAllOrderListViewController.h"
#import "UserAllOrderDataSource.h"
@implementation UserAllOrderListViewController
...
-(void) loadView{
    ...
    self.dataSource = [[[UserAllOrderDataSource alloc] init] autorelease];
}
...
-(void)didSelectObject:(id)object atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([object isMemberOfClass:[TTTableTextItem class]]) {
        ...
        //NSLog(@"order %@",((TTTableTextItem*)object).userInfo);
        //NSLog(@"\"SEAT_STATUS\" %d",[[((TTTableTextItem*)object).userInfo objectForKey:@"SEATSTATUS"] intValue]);
