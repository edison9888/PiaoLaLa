...
#import "UserOrderViewContrller.h"

@implementation UserOrderViewContrller
...
-(void)loadView{
    ...
    UIViewController * a = [kAppDelegate loadFromVC:@"UserAllOrderListViewController"];
    a.title = @"全部";
    UIViewController * b = [kAppDelegate loadFromVC:@"UserPayOrderListViewController"];
    b.title = @"已付款";
    UIViewController * c = [kAppDelegate loadFromVC:@"UserNoPayOrderListViewController"];
    c.title = @"未付款";
    
    self.viewControllers = [NSArray arrayWithObjects:a,b,c,nil ];
}
