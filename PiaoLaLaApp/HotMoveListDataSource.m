...
#import "HotMoveListDataSource.h"
#import "MoveListCell.h"
#import "HotMoveListModel.h"
@implementation HotMoveListDataSource


- (id<TTModel>)model {
	if (!_model) {
		_model = [[HotMoveListModel alloc] initWithResultsPerPage:@"10"];
	}
	return _model;
}
