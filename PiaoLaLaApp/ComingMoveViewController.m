...
@implementation ComingMoveViewController
...
-(void)finishUpdata:(ASIHTTPRequest *)request{
   ...
   // [kAppDelegate.temporaryValues setObject:interestingPhotosDictionary forKey:@"comingMove"];
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSUInteger)index
{
	...
	UIView *view = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"mrtp.png"]] autorelease];
...
-(void)moveDeatil{
	...
	[appDelegate HUDShow:@"查询中" yOffset:@"0"];
	//请求详情
	NSMutableDictionary *postData = [[NSMutableDictionary alloc] init];
