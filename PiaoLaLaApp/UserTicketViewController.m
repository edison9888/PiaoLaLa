...
-(void)loadView{
    ...
    UIViewController * a = [kAppDelegate loadFromVC:@"UserTicketDzTableViewController"];
    a.title = @"电子通票";
    UIViewController * b = [kAppDelegate loadFromVC:@"UserTicketDzTableViewController"];
    b.title = @"订座票";
