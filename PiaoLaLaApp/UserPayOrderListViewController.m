//
//  UserPayOrderListViewController.m
//  piaoLaLa
//
...
#import "UserPayOrderListViewController.h"
#import "UserPayOrderDataSource.h"

@implementation UserPayOrderListViewController
...
-(void) loadView{
    ...
    self.dataSource = [[[UserPayOrderDataSource alloc] init] autorelease];
}
