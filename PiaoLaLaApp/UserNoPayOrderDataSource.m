...
#import "UserNoPayOrderModel.h"
@implementation UserNoPayOrderDataSource
...
- (id<TTModel>)model {
	if (!_model) {
		_model = [[UserNoPayOrderModel alloc] initWithResultsPerPage:@"10"];
	}
	return _model;
}
