...
#import "HotMoveListViewController.h"
#import "HotMoveListDataSource.h"
@implementation HotMoveListViewController
...
-(void)loadView{
    ...
    self.dataSource =  [[[HotMoveListDataSource alloc] init] autorelease];
}
