...
#import "PassOrderViewController2.h"

@implementation PassOrderViewController2
...
-(void)loadView{
    ...
    _titleLabel.text = [[kAppDelegate.temporaryValues objectForKey:@"SelsectCINEMA"] objectForKey:@"CINEMANAME"];
//    [_titleLabel sizeToFit];
//    if (_titleLabel.frame.size.width>165) {
//         _titleLabel.frame = CGRectMake(60, (22/2),165, 22);
//    }
