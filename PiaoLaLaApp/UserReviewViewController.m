...
-(void)loadView{
    ...
    UIViewController * a = [kAppDelegate loadFromVC:@"UserMoveReviewViewCotnroller"];
    a.title = @"影片评论";
    UIViewController * b = [kAppDelegate loadFromVC:@"UserCinemaReviewViewController"];
    b.title = @"影院评论";
