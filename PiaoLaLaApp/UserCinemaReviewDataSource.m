...
#import "UserCinemaReviewModel.h"
@implementation UserCinemaReviewDataSource

- (id<TTModel>)model {
	if (!_model) {
		_model = [[UserCinemaReviewModel alloc] initWithResultsPerPage:@"10"];
	}
	return _model;
}
